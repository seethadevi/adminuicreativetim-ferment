...
export class AdminLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor( private router: Router, location: Location, private store: Store<any>, private cd: ChangeDetectorRef) {
    ...
    ngOnInit() {
      ...
      this.pageSubscription = this.store.select<any>((state: any) => state)
        .subscribe((s: any) => {
          if (this.pageLoading !== s.appMainStore.isAppLoading) {
            this.pageLoading = s.appMainStore.isAppLoading;
